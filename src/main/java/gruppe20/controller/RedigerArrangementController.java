...
public class RedigerArrangementController {
    ...
    private boolean sjekkOmInputErGyldig() {
        ...
        // Sjekker om det er noe innhold i titteltekstfeltet (arrangement må ha navn for å bli sett på lista)
        ...
        // Sjekker om det er noe innhold i beskrivelsefeltet
        if (beskrivelseTextArea.getText() == null || beskrivelseTextArea.getText().length() ==0) {
            feilmelding += "Skriv noe om arrangementet";
        }

        // Prøver å parse klokkeslett fra String til int
        try {
